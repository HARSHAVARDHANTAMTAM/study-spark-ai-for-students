  ...
  head: () => ({
    meta: [
      ...
      { title: "StudySpark AI — Learn Smarter with AI" },
      {
        name: "description",
        content:
          "Upload notes and let AI explain concepts, answer questions, generate quizzes and build personalized study plans.",
      },
      { name: "author", content: "StudySpark AI" },
      { property: "og:title", content: "StudySpark AI — Learn Smarter with AI" },
      {
        property: "og:description",
        content: "Your AI study buddy for notes, quizzes, flashcards and revision plans.",
      },
